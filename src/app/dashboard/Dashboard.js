                 ...
                 <div className="card">
                     <div className="card-body">
                         <div className="row">
                             <div className="col-9">
                                 <div className="d-flex align-items-center align-self-start">
                                     <h3 className="mb-0">{numeral(dash.bird_no['1']).format("0,0")}</h3>
                                     <p className={`text-success ml-2 mb-0 font-weight-medium`}>
                                         {'+'.concat(numeral().format("0,0.0"))}%
                                     </p>
                                 </div>
                   ...
                   { pend && pend.filter((x) => x.values.col_id === '4' && x.create === true)?.length !== 0 &&
                       <div className="table-responsive">
                           ...
                           {pend && pend.filter((x) => x.values.col_id === '4' && x.create === true).map((item) => {
                               ...
                               return (
                                   <tr key={item.id} className={`text-${(item.hasOwnProperty('rejected')) ? 'white' : 'muted'}`}>
                                       <td>
                                           <div className="form-check form-check-muted m-0">
                                               <label className="form-check-label">
                                       ...
                                       <td>
                                           {(item?.rejected > 0)
                                               ...
                                               : (item?.rejected === 0) ? <div className="badge badge-outline-success">Ready</div>
